...
router.post("/", authMiddleware(["admin"]), async (req, res) => {
  try {
    ...
    if (!["admin", "analyst", "jefe_turno"].includes(role))
    ...
    const rolDB = role === "analyst" ? "analista" : role === "jefe_turno" ? "jefe_turno" : "admin";
...
router.put("/:id", authMiddleware(["admin"]), async (req, res) => {
  try {
    ...
    const rolDB = role === "analyst" ? "analista" : role === "jefe_turno" ? "jefe_turno" : role === "admin" ? "admin" : null;
    await db.execute(
